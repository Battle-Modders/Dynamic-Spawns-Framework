local parties = [
	{
		...
		VisionMult = 1.0,
		UnitBlockDefs = [
			{ ID = "Goblin.Frontline", RatioMin = 0.00, RatioMax = 1.00, MaxStartingResource = 140, DeterminesFigure = true},
			{ ID = "Goblin.Ranged", RatioMin = 0.00, RatioMax = 1.00, MaxStartingResource = 140, DeterminesFigure = true},
			{ ID = "Goblin.Flank", RatioMin = 0.00, RatioMax = 1.00, MinStartingResource = 120, DeterminesFigure = true}		// Lategame GoblinRoamer only consist of Riders
		]
	},
	...
	},
	{
		...
		UnitBlockDefs = [
			...
			{ ID = "Goblin.Boss", RatioMin = 0.01, RatioMax = 0.15, MinStartingResource = 250, DeterminesFigure = true}	// One boss is guaranteed at 250+ resources
	   ]
	},
	{
		ID = "GoblinDefenders",
