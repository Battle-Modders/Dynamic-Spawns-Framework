 ...
 */
 ::DynamicSpawns.Tests.checkAll <- function( _printInfo = true, _printWarnings = true )
 {
 ...
 ::DynamicSpawns.Tests.checkPartyDef <- function( _partyKey, _partyDef, _printInfo = true, _printWarnings = true )
 {
	local logsGenerated = 0;
 ...
 ::DynamicSpawns.Tests.checkUnitBlockDef <- function( _unitBlockKey, _unitBlockDef, _printInfo = true, _printWarnings = true )
 {
	local logsGenerated = 0;
 ...
 ::DynamicSpawns.Tests.checkUnitDef <- function( _unitKey, _unitDef, _printInfo = true, _printWarnings = true )
 {
	local logsGenerated = 0;
 ...
 ::DynamicSpawns.Tests.checkVanillaParty <- function( _vanillyKey, _vanillaParty, _printInfo = true, _printWarnings = true)
 {
	local logsGenerated = 0;
